...
namespace AlbertCollection.Application.Services
{
    ...
    public class AuthService : IAuthService
    {
        ...
        /// <inheritdoc/>
        public async Task<SysUserAc> GetLoginUser()
        {
        ...
        /// <returns></returns>
        private async Task<LoginOutPut> Login(SysUserAc sysUser, AuthDeviceTypeEnum device)
        {
