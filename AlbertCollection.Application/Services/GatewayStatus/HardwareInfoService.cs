...
namespace AlbertCollection.Application.Services.GatewayStatus;
        ...
        _ = Task.Run(async () =>
         {
             ...
             appInfo = new()
             {
                 ...
                 UpdateTime = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss:fffffff"),
             };
             while (true)
             {
                 try
                 {
                     appInfo.UpdateTime = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss:fffffff");
