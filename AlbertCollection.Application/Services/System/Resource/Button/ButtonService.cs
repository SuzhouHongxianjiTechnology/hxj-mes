...
namespace AlbertCollection.Application
{
    ...
    public class ButtonService : DbRepository<SysResourceAc>, IButtonService
    {
        ...
        /// <inheritdoc/>
        public async Task<SqlSugarPagedList<SysResourceAc>> Page(ButtonPageInput input)
        {
            var query = Context.Queryable<SysResourceAc>()
