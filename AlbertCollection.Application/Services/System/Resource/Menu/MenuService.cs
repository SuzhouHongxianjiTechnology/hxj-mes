...
namespace AlbertCollection.Application
{
    ...
    public class MenuService : DbRepository<SysResourceAc>, IMenuService
    {
        ...
        public async Task Add(MenuAddInput input)
        {
            ...
            var sysResource = input.Adapt<SysResourceAc>();//实体转换
        ...
        public async Task Delete(List<BaseIdInput> input)
        {
            ...
            if (ids.Count > 0)
            {
                ...
                var result = await itenant.UseTranAsync(async () =>
                {
                    ...
                    await Context.Deleteable<SysRelationAc>()//关系表删除对应SYS_ROLE_HAS_RESOURCE
        ...
        /// <inheritdoc />
        public async Task<SysResourceAc> Detail(BaseIdInput input)
        {
        ...
        /// <inheritdoc />
        public async Task<List<SysResourceAc>> Tree(MenuPageInput input)
        {
            //获取所有菜单
            var sysResources = await _resourceService.GetListByCategory(MenuCategoryEnum.MENU);
        ...
        private async Task CheckInput(SysResourceAc sysResource)
        {
            //获取所有菜单列表
