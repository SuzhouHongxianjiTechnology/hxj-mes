...
namespace AlbertCollection.Web.Rcl.Core
{
    ...
    public class UserResoures : IDisposable
    {
        ...
        public SysUserAc CurrentUser { get; set; }
        public bool IsDark => _masaBlazor.Theme.Dark;

        public List<SysResourceAc> Menus { get; set; }
        public List<SysResourceAc> WorkbenchOutputs { get; set; }
        public List<SysResourceAc> SameLevelMenus { get; private set; } = new();
        public List<SysResourceAc> AllSameLevelMenus { get; private set; } = new();
