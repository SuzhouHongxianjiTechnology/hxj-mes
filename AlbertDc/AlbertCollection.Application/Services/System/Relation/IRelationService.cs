...
namespace AlbertCollection.Application
{
    ...
    public interface IRelationService : ITransient
    {
        ...
        Task<SysRelationAc> GetWorkbench(long userId);
        ...
        /// <returns>关系表</returns>
        Task<List<SysRelationAc>> GetRelationByCategory(string category);
        ...
        /// <returns></returns>
        Task<List<SysRelationAc>> GetRelationListByObjectIdAndCategory(long objectId, string category);
        ...
        /// <param name="category">分类</param>
        /// <returns></returns>
        Task<List<SysRelationAc>> GetRelationListByObjectIdListAndCategory(List<long> objectIds, string category);
        ...
        /// <param name="category">分类</param>
        /// <returns></returns>
        Task<List<SysRelationAc>> GetRelationListByTargetIdAndCategory(string targetId, string category);
        ...
        /// <returns></returns>
        Task<List<SysRelationAc>> GetRelationListByTargetIdListAndCategory(List<string> targetIds, string category);
