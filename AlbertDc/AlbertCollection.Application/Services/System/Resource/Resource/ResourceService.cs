...
namespace AlbertCollection.Application
{
    ...
    public class ResourceService : DbRepository<SysResourceAc>, IResourceService
    {
        ...
        /// <inheritdoc/>
        public async Task<List<SysResourceAc>> GetaMenuAndSpaList()
        {
            //获取所有的菜单以及单页面
        ...
        /// <inheritdoc />
        public List<SysResourceAc> GetChildListById(List<SysResourceAc> sysResources, long resId, bool isContainOneself = true)
        {
            //查找下级
        ...
        /// <inheritdoc/>
        public async Task<List<SysResourceAc>> GetListAsync(List<MenuCategoryEnum> categoryList = null)
        {
            //定义结果
            var sysResources = new List<SysResourceAc>();
        ...
        /// <inheritdoc />
        public async Task<List<SysResourceAc>> GetListByCategory(MenuCategoryEnum category)
        {
            //先从Cache拿
            var sysResources = _sysCacheService.Get<List<SysResourceAc>>(CacheConst.Cache_SysResource, category.ToString());
            if (sysResources == null)
            {
                //cache没有就去数据库拿
        ...
        /// <returns></returns>
        public List<SysResourceAc> GetResourceChilden(List<SysResourceAc> resourceList, long parentId)
        {
            //找下级资源ID列表
        ...
        /// <returns></returns>
        public List<SysResourceAc> GetResourceParent(List<SysResourceAc> resourceList, long parentId)
        {
            //找上级资源ID列表
        ...
        private async Task<List<RoleGrantResourceMenu>> GetRoleGrantResourceMenus()
        {
            ...
            List<SysResourceAc> allMenuList = (await GetListByCategory(MenuCategoryEnum.MENU));//获取所有菜单列表
            List<SysResourceAc> allButtonList = await GetListByCategory(MenuCategoryEnum.BUTTON);//获取所有按钮列表
        ...
        /// <returns></returns>
        private string GetRoleGrantResourceMenuTitle(List<SysResourceAc> menuList, SysResourceAc menu)
        {
            //查找菜单上级
