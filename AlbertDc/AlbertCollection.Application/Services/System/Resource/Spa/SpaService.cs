...
namespace AlbertCollection.Application
{
    ...
    public class SpaService : DbRepository<SysResourceAc>, ISpaService
    {
        ...
        /// <inheritdoc/>
        public async Task<SqlSugarPagedList<SysResourceAc>> Page(SpaPageInput input)
        {
        ...
        private void CheckInput(SysResourceAc sysResource)
        {
            //判断菜单类型
