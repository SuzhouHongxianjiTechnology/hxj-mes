...
namespace AlbertCollection.Application
{
    ...
    public interface IRoleService : ITransient
    {
        ...
        /// <param name="userId">用户ID</param>
        /// <returns></returns>
        Task<List<SysRoleAc>> GetRoleListByUserId(long userId);
        ...
        /// <returns></returns>
        Task<SqlSugarPagedList<SysRoleAc>> Page(RolePageInput input);
        ...
        /// 角色选择器
        /// </summary>
        Task<List<SysRoleAc>> RoleSelector(string searchKey = null);
    }
}