...
namespace AlbertCollection.Core
{
    ...
    public static class DateUtil
    {
        ...
        {
            int year = DateTime.UtcNow.Year + (month / 12);
            if (month != 12)
            {
                month %= 12;
            }
            ...
            {
                case 1:
                    firstDay = DateTime.UtcNow.ToString($"{year}-0{month}-01");
                    lastDay = DateTime.UtcNow.ToString($"{year}-0{month}-31");
                    break;

                case 2:
                    firstDay = DateTime.UtcNow.ToString(year + "-0" + month + "-01");
                    lastDay = DateTime.IsLeapYear(DateTime.UtcNow.Year) ? DateTime.UtcNow.ToString(year + "-0" + month + "-29") : DateTime.UtcNow.ToString(year + "-0" + month + "-28");
                    break;

                case 3:
                    firstDay = DateTime.UtcNow.ToString(year + "-0" + month + "-01");
                    lastDay = DateTime.UtcNow.ToString("yyyy-0" + month + "-31");
                    break;

                case 4:
                    firstDay = DateTime.UtcNow.ToString(year + "-0" + month + "-01");
                    lastDay = DateTime.UtcNow.ToString(year + "-0" + month + "-30");
                    break;
                ...
                case 10:
                    firstDay = DateTime.UtcNow.ToString(year + "-" + month + "-01");
                    lastDay = DateTime.UtcNow.ToString(year + "-" + month + "-31");
                    break;

                case 11:
                    firstDay = DateTime.UtcNow.ToString(year + "-" + month + "-01");
                    lastDay = DateTime.UtcNow.ToString(year + "-" + month + "-30");
                    break;
