        ...
        <el-scrollbar style="height: 100%">
          <div :class="deviceIndex === index ? 'device-item active' : 'device-item'" v-for="(item, index) in deviceList" :key="index">
            <div class="device-box">
              ...
              <div class="device-box-right" @click="item.open = !item.open">
                <i class="el-icon-arrow-down" v-show="!item.open"></i>
                <i class="el-icon-arrow-up" v-show="item.open"></i>
              </div>
            </div>
            <div class="station" v-show="item.open">
          ...
          <div v-for="(stationItem, stationIndex) in deviceList[deviceIndex].StationSeqs" :key="stationItem.Id" class="station-item" :id="'station' + stationItem.Id">
            ...
            <div class="form-list">
              <template v-for="(stationValue, stationKey) in stationItem">
                <div :class="stationKey === 'ReadData' ? 'form-item form-item-table' : 'form-item form-item-input'" v-if="stationKey === 'ReadData'">
                  <EditTable :dataList="stationItem[stationKey]" :deviceIndex="deviceIndex" :stationIndex="stationIndex" :stationId="stationItem['Id']" />
                </div>
                <div :class="stationKey === 'ReadData' ? 'form-item form-item-table' : 'form-item form-item-input'" v-if="stationKey !== 'ReadData'">
